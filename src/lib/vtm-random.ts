...
const SIRE_INTENTS = [
  "выбрал меня за талант и не отпустил",
  "испортил Становление случайно и сбежал",
  "проиграл пари и обязан был меня обратить",
  "нуждался в наследнике для грязных дел",
  "полюбил мой смех при жизни",
  "мстил моему роду через меня",
  "спас от смерти — как он утверждает",
  "выкупил меня у другой Крови",
];
