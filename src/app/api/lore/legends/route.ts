...
const items = _full
  ? slimImages("legend", await db.legend.findMany({ orderBy: { createdAt: "desc" } }), true)
  : slimImages("legend", await db.legend.findMany({ orderBy: { createdAt: "desc" }, omit: { image: true } }), false);
