          ...
          >
            ...
            {last && (
              <div className="space-y-2">
                ...
                {last.bestial && (
                  <p className="vtm-hint">Зверский провал: рассказчик вправе усложнить ситуацию — Голод берёт верх. (Испытание Крови не требуется, но последстви я могут быть кровавыми.)</p>
                )}
                {last.messy && (
