  ...
  const blocks: { title: string; body: string[] }[] = [
    ...
    },
    {
      ...
      body: [
        ...
        "Человечность: 2 × новое звено. Сила Крови сверх поколения: 10 × новый уровень (Клик по пунктирной точке в Досье). Факты биографии после создания: 3 опыта за точку. Листоги («Истории») — 3–7 опыта за ступень.",
