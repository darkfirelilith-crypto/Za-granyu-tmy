  ...
  const blocks: { title: string; body: string[] }[] = [
    ...
    },
    {
      ...
      body: [
        ...
        "Человечность: 2 × новое звено. Сила Крови сверх поколения: каждая ступень стоит 10 × её уровень (2→3 = 20; подъём растёт ступенями). Факты биографии после создания: 3 опыта за точку. Листоги («Истории») — 3–7 опыта за ступень.",
        "Опыт записывай в трекерах (Досье) — вкладывай с Рассказчиком. Вся история операций листа — вкладка «Хроника».",
      ],
    },
  ];
