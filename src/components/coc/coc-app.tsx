...
function CocHelpPanel() {
  const steps: { n: string; title: string; text: string }[] = [
    ...
    {
      n: "III",
      title: "Навыки: режим прокачки",
      text: "Кнопка «Прокачка» открывает распределение очков: профессии — только в помеченные ☒ навыки, личные (ИНТ×2) — в любые; у групповых навыков (Искусство/ремесло, языки) можно уточнить конкретику. В обычном режиме у навыка видны итог и пороги ½ / ⅕ — клик по любому = проверка d100 с нужным порогом. Провал можно исправить удачей: −1/−5/−10 прямо в печати результата.",
    },
    {
      n: "IV",
