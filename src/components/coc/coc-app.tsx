...
function CocHelpPanel() {
  const steps: { n: string; title: string; text: string }[] = [
    ...
    },
    {
      ...
      text: "Кнопка «Прокачка» открывает распределение очков: профессии — только в навыки специализации ☒, личные (ИНТ×2) — в любые; ↑ помечает пройденные навыки — на следующей арке их прокачают. В обычном режиме у навыка видны итог и пороги ½ / ⅕ — клик по любому = проверка d100 с нужным порогом. Провал можно исправить удачей: −1/−5/−10 прямо в печати результата.",
    },
    {
      n: "IV",
