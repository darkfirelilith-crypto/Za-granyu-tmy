...
async function main() {
  ...
  // === Grimoire (locked) ===
  const grimoire = [
    { title: 'Глава I: О Первородном Молчании', encodedContent: 'Zkyq jvyqiv wlez jvmle vmzk pql wv eviiz kjrxl. Vmxlj kymwj, vmxlj rzxv, vmxlj jvyq.', realContent: 'В начале было не слово, но молчание. Боги не создали мир — они лишь нашли его спящим и дали ему имя. То, что спало, не умерло. Оно ждёт.', unlocked: false, unlockHint: 'Найди Серебряную Рощу и услышь её песню.', category: 'HISTORY', order: 1 },
    { title: 'Глава II: Об истинном имени Морганта', encodedContent: 'Wznn gzi nzmw, wznn gzi mewz — nz aewq vkgz pkmwj uqmif. Nz aewq qvqpv.', realContent: 'Моргант не мёртв. Моргант не спит — он лишь сменил личину. Он ждёт среди живущих под именем, которое вы произносите каждый день.', unlocked: false, unlockHint: 'Получи достижение «Укротитель Дракона».', category: 'SECRETS', order: 2 },
    { title: 'Глава III: Ритуал Разрыва', encodedContent: 'Qrwmqlk pkmza qlk wzk aqm, azqlk wzk pql, kmjj qlk wzk qvqpv. Pkx pkmz nkxq.', realContent: 'Ритуал, способный отнять силу у бога: шесть свечей из слёз, зеркало тёмной воды и имя, произнесённое назад. Но цена — душа заклинателя.', unlocked: false, unlockHint: 'Достигни ранга Мифического Чемпиона.', category: 'RITUALS', order: 3 },
    { title: 'Глава IV: Пророчество Седьмой Эры', encodedContent: 'Jwvkm, nlmv, qvql wlez mzm, nza wvk wrk vlmv kzk. Wvk wrk qvql kmzk wvk.', realContent: 'Когда тьма, что спит, откроет седьмой глаз, боги падут, и мир станет тем, кем был до них. Хранители Серебряного Пламени — последняя преграда.', unlocked: false, unlockHint: 'Открой предыдущие три страницы.', category: 'PROPHECY', order: 4 },
  ]
